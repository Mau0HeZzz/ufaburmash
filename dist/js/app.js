 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector("[data-menu-close]")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest("[data-menu-close]")) {
                    bodyLockToggle();
        ...
        function initSliders() {
            ...
            if (productSlider) {
                ...
                productSlider.hasAttribute("data-slides") && parseFloat(productSlider.hasAttribute("data-slides"));
                new core(productSlider, {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    speed: 800,
            ...
            if (newsSlider) {
                ...
                newsSlider.hasAttribute("data-slides") && parseFloat(newsSlider.hasAttribute("data-slides"));
                new core(newsSlider, {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
        ...
        function headerScroll() {
            ...
            if (header) {
                ...
                const startPoint = header.dataset.scroll ? header.dataset.scroll : window.innerWidth <= 767 ? header.offsetHeight : 1;
                ...
                document.addEventListener("windowScroll", (function(e) {
                    ...
                    if (scrollTop >= startPoint) {
                        ...
                        toppage && !toppage.classList.contains("_header-scroll") ? toppage.classList.add("_header-scroll") : null;
                        if (headerShow) {
                        ...
                        toppage && toppage.classList.contains("_header-scroll") ? toppage.classList.remove("_header-scroll") : null;
...
***************************************************************************** */
        ...
        function filtersActions(filterParent) {
            ...
            if (filterOpenButton && filterBody) {
                ...
                document.addEventListener("click", (e => {
                    if (e.target !== filterOpenButton && !e.target.closest("[data-filters-body]") || e.target.closest(".filters-hero__ok") || e.target.closest("[data-filters-close]")) filterBody.classList.remove("_active");
                }));
            }
                ...
                filterSbrosButton.addEventListener("click", (e => {
                    ...
                    if (parent) {
                        ...
                        textinputs.length ? textinputs.forEach((textinput => {
                            ...
                            if ("checkbox" === type || "radio" === type) textinput.checked = false; else textinput.value = "";
                        })) : null;
                        filterCheck();
                    }
                }));
                ...
                filterItems ? filterItems.forEach((filterItem => {
                    ...
                    inputs.length ? inputs.forEach((input => {
                        ...
                        if ("checkbox" === type || "radio" === type) {
                            if (input.checked) arr.push(input);
                        } else if ("" !== input.value) arr.push(input);
                    })) : null;
                    if (arr.length) filterItem.classList.add("_changed"); else filterItem.classList.remove("_changed");
                })) : null;
            }
        }
        function productInfoImgsActions(productInfo, productImgs) {
            ...
            productInfo.style.minHeight = window.innerWidth > 650 ? `${1.1 * productInfoHeight}px` : "";
        ...
        function init() {
            ...
            if (mapContainer) {
                let center = mapContainer.hasAttribute("data-center") ? mapContainer.getAttribute("data-center") : "54.682919, 55.797497";
                let zoom = mapContainer.hasAttribute("data-zoom") ? parseFloat(mapContainer.getAttribute("data-zoom")) : 12;
                new ymaps.Map(mapContainer, {
                    center: center.replaceAll(" ", "").split(","),
                    zoom,
