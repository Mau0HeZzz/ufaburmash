	...
	function pageNavigationAction(e) {
		if (e.type === "click") {
			...
			if (targetElement.closest('[data-goto]')) {
				...
				let offsetTopMobile;
				if (window.innerWidth > 1020 && window.innerWidth < 1240) {
					offsetTopMobile = gotoLink.dataset.gotoTopMobile ? parseInt(gotoLink.dataset.gotoTopMobile) + 50 : 0;
				} else {
					offsetTopMobile = gotoLink.dataset.gotoTopMobile ? parseInt(gotoLink.dataset.gotoTopMobile) : 0;
				}
